...
export function SendFundsCard() {
  return (
    <div className="rounded-2xl bg-[#141414] border border-[#262626] p-6 flex flex-col">
      ...
      <h3 className="mb-2 text-lg font-semibold text-white">Мгновенная оплата</h3>
      <p className="mb-4 text-sm text-gray-400">Плати за аренду прямо в Dash — быстро, без выхода из игры и лишних действий</p>
      ...
      <div className="mt-auto space-y-4 rounded-xl bg-[#1a1a1a] border border-[#262626] p-4">
        <div className="flex items-center justify-between rounded-lg bg-[#0f0f0f] border border-[#262626] px-3 py-2.5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-white">Баланс Dash</p>
              <p className="text-xs text-gray-500">Доступно: 15 000 $</p>
            </div>
          </div>
        ...
        <div>
          <label className="mb-2 flex items-center gap-1 text-xs text-gray-400">
            Место получения авто <span className="text-violet-400">*</span>
          </label>
          <div className="relative">
            <textarea
              placeholder="Укажи адрес или район на карте..."
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <span className="text-sm text-gray-400">Продлить автоматически</span>
        </div>
      </div>
    </div>
  )
